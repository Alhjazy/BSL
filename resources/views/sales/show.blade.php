...
@section('content')
    ...
    <div id="main" class="intro-y box p-5 mt-5">
        <div class="flex flex-col sm:flex-row sm:items-end xl:items-start">
            <form class="xl:flex sm:mr-auto" id="order_info">
                <div class="sm:flex items-center sm:mr-4">
                    <div class="flex">
                        <div class="z-30 rounded-l w-40 flex items-center justify-center bg-gray-100 border text-gray-600 dark:bg-dark-1 dark:border-dark-4 -mr-1">Reference#</div>
                        <input type="text" name="reference" class=" input w-full sm:w-40 xxl:w-full mt-2 sm:mt-0 border"  disabled value="{{$sales['reference']}}"  placeholder="Search...">
                    </div>
                </div>
                <div class="sm:flex items-center sm:mr-4 mt-2 xl:mt-0">
                    <div class="flex">
                        <div class="z-30 rounded-l w-40 flex items-center justify-center bg-gray-100 border text-gray-600 dark:bg-dark-1 dark:border-dark-4 -mr-1">Branch</div>
                        <select name="branch_id" id="branch_id"  class="tail-select branch_id w-40" >
                            <option value="{{$sales['branch_id']}}" selected>{{$sales['branch']['name']}}</option>
                        </select>
                    </div>
                </div>
                <div class="sm:flex items-center sm:mr-4 mt-2 xl:mt-0">
                    <div class="flex">
                        ...
                        <input type="text" name="issued_date" disabled value="{{$sales['issued_date']}}" class="datepicker input w-full sm:w-40 xxl:w-full mt-2 sm:mt-0 border" data-format="YYYY/MM/DD" data-single-mode="true"  placeholder="Search...">
                    </div>
                </div>
                <div class="sm:flex items-center sm:mr-4 mt-2 xl:mt-0">
                    <div class="flex">
                        ...
                        <input type="text" name="due_date" disabled value="{{$sales['due_date']}}" class="datepicker input w-full sm:w-40 xxl:w-full mt-2 sm:mt-0 border" data-format="YYYY/MM/DD" data-single-mode="true"  placeholder="Search...">
                    </div>
                </div>
                <div class="sm:flex items-center sm:mr-4 mt-2 xl:mt-0">
                    <div class="flex">
                        <div class="z-30 rounded-l w-40  flex items-center justify-center bg-gray-100 border text-gray-600 dark:bg-dark-1 dark:border-dark-4 -mr-1">Customer</div>
                        <input type="text" name="customer_id" class=" input w-full sm:w-40 xxl:w-full mt-2 sm:mt-0 border"  disabled value="{{$sales['customer']['name']}}"  placeholder="Search...">
                    </div>
                </div>
                <br>
                <hr>
        ...
        <div class="overflow-x-auto scrollbar-hidden">
            <div class="mt-5 table-report table-report--tabulator" id="SalesOrdersItems"></div>
        </div>
        <br>
        <div class="overflow-x-auto">
            <table class="table" style="width: 34%;float: left;">
                ...
                <tr>
                    <td class="border-b" align="right" id="payemnts_metods">
                        @foreach($sales['payments'] as $key => $value)
            ...
            <table class="table" style="width: 34%; float: right;">
                <tbody>
                <tr>
                    <td class="border-b" align="right" id="SUBTOTAL">  {{$sales['subtotal']}} </td>
                    <td class="border-b" align="right" style="width: 40%;"> : SUBTOTAL  -  الإجمالي الجزئي</td>
                </tr>
                <tr>
                    <td class="border-b" align="right" id="DISCOUNT"> {{$sales['total_discount_amount']}} </td>
                    <td class="border-b" align="right" style="width: 70%;"> : TOTAL DISCOUNT AMOUNT  - إجمالي قيمة الخصم </td>
                </tr>
                <tr>
                    <td class="border-b" align="right" id="TOTAL_TAX">{{$sales['total_tax_amount']}} </td>
                    <td class="border-b" align="right" style="width: 70%;"> : TOTAL VAT TAX AMOUNT  -  إجمالي قيمة الضريبة المضافة</td>
                </tr>
                <tr>
                    <td class="border-b" align="right" id="TOTAL"> {{$sales['total_amount']}} </td>
    ...
    <div class="modal" id="payment-modal-preview">
        <div  class="modal__content modal__content--xl p-10">
            <div class="flex items-center px-5 py-5 sm:py-3 border-b border-gray-200 dark:border-dark-5">
                <h2 class="font-medium text-base mr-auto">Sales Payments</h2>
...
//            return data.age > 18; // only allow the name cell to be edited if the age is over 18
        ...
        var table = new Tabulator("#SalesOrdersItems", {
//            data:tabledata,           //load row data from array
            ajaxURL:"/sales/orders/{{$sales['id']}}/items",
