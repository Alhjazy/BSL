    ...
    <div class="flex-grow overflow-hidden h-full flex flex-col">
        <div class="h-16 lg:flex w-full border-b border-gray-200 dark:border-gray-800 hidden px-10">
            <div class="flex h-full text-gray-600 dark:text-gray-400">
                ...
                <a href="#" class="cursor-pointer h-full border-b-2 border-blue-500 text-blue-500 dark:text-white dark:border-white inline-flex mr-8 items-center">Employee's</a>
                <a href="#" class="cursor-pointer h-full border-b-2 border-transparent inline-flex items-center mr-8">Accounting</a>
                <a href="#" class="cursor-pointer h-full border-b-2 border-transparent inline-flex items-center mr-8">Marketing</a>
                <a href="#" class="cursor-pointer h-full border-b-2 border-transparent inline-flex items-center mr-8">Reports</a>
                <a href="#" class="cursor-pointer h-full border-b-2 border-transparent inline-flex items-center">POS RETAILS</a>
            </div>
