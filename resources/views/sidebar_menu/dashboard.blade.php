<button class="relative text-sm focus:outline-none group">
    <div class="flex items-center justify-between w-full h-16 px-4 border-b border-gray-300 hover:bg-gray-300">
                        <span id="sidebarItemsMenuParentName" class="font-medium">
                            Dashboard
                        </span>
    ...
    <div id="sidebarItemsParentMenuSections" class="absolute z-10 flex-col items-start hidden w-full pb-1 bg-white shadow-lg group-focus:flex">
