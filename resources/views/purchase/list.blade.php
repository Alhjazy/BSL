...
@section('content')
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            <a href="/purchase/orders/create" class="button text-white bg-theme-1 shadow-md mr-2">New Orders</a>
            <div class="dropdown">
        ...
        <div class="intro-y col-span-12 overflow-auto lg:overflow-visible">
            <table class="table table-report -mt-2">
                ...
                <tr>
                    ...
                    <th class="text-center whitespace-nowrap">ORDER INVOICE#</th>
                ...
                @if($orders) @foreach($orders as $key => $value)
                    <tr class="intro-x">
                        ...
                        <td class="text-center"><a href="/purchase/orders/{{$value->id}}/show" class="font-medium whitespace-nowrap">{{$value->reference}}</a></td>
                        <td>
                        ...
                        <td>
                            <a href="/purchase/orders/{{$value->id}}/show" class="font-medium whitespace-nowrap">{{$value->supplier->name}}</a>
                            <div class="text-gray-600 text-xs whitespace-nowrap mt-0.5">{{$value->supplier->phone_number}}</div>
                        </td>
                        <td class="text-center"><a href="/purchase/orders/{{$value->id}}/show" class="font-medium whitespace-nowrap">{{$value->invoice_no}}</a></td>
