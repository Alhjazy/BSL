        ...
        <div class="flex-grow bg-white dark:bg-gray-900 overflow-y-auto">
            <div class="sm:px-7 sm:pt-7 px-4 pt-4 flex flex-col w-full border-b border-gray-200 bg-white dark:bg-gray-900 dark:text-white dark:border-gray-800 sticky top-0">
                ...
                <div class="flex items-center space-x-3 sm:mt-7 mt-4">
                    ...
                    <a href="/settings/departments" class="px-3 border-b-2 border-blue-500 text-blue-500 dark:text-white dark:border-white pb-1.5">Departments</a>
            ...
            <div class="sm:p-7 p-4">
                ...
                <table class="w-full text-left">
                    ...
                    <tr class="text-gray-400">
                        ...
                        <th class="font-normal px-3 pt-0 pb-3 border-b border-gray-200 dark:border-gray-800">Parent Department</th>
                    ...
                    @if($department) @foreach($department as $k => $v)
                        <tr>
